    ...
    public class UsersController : BaseApiController
    {
        ...
        public async Task<ActionResult<IEnumerable<MemberDto>>> GetUsers([FromQuery]UserParams userParams)
        {
            ...
            if (string.IsNullOrEmpty(userParams.Gender))
                if (string.IsNullOrEmpty(user.Gender)) userParams.Gender = "female";
                else userParams.Gender = user?.Gender.ToLower() == "male" ? "female" : "male";
        ...
        public async Task<ActionResult<MemberDto>> GetUser(string username)
        {
            ...
            return _mapper.Map<MemberDto>(await _userRepository.GetMemberByUsernameAsync(username));
        }
        ...
        public async Task<ActionResult<PhotoDto>> DeletePhoto(int photoId)
        {
            ...
            if (await _userRepository.SaveAllAsync()) return Ok(response);
