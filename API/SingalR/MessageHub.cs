...
namespace API.SingalR
{
    public class MessageHub : Hub
    {
        ...
        public override async Task OnConnectedAsync()
        {
            ...
            var messagesForConnector = await _messageRepository.GetMessageThread(Context.User.GetUsername(), otherUser);
            var messagesForConnected = await _messageRepository.GetMessageThread(otherUser, Context.User.GetUsername());
